...
function initTablet() {
    ...
    window.mainTimeline = tlTablet;

    tlTablet.eventCallback("onUpdate", () => {
        updateActiveNavFromTimeline(tlTablet);
    });

    /* HERO */

 
    tlTablet.addLabel("hero");
